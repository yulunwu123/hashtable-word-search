...
private:
    ...
    void insert(BinaryNode *&i, const string &s);
    bool find(BinaryNode *const &someNode, const string &someString) const;
    string pathTo(BinaryNode *const &someNode, const string &x) const;
    int numNodes(BinaryNode *const &someNode) const;
};
